"""resnetin pytorch taken from https://github.com/weiaicunzai/pytorch-cifar100/blob/master/models/resnet.py
Default setting: MNIST
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=10, name="resnet"):
        super().__init__()
